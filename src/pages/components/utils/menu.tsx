      ...
      <Menu as="div" className="relative inline-block text-left">
        <div>
          <Menu.Button className="inline-flex w-16 h-16 justify-center rounded-full">
            <span className="relative w-16 h-16 rounded-full bg-transparent  border border-slate-300">
              <Image
                src={
        ...
        >
          <Menu.Items className="absolute z-10 right-0 top-full mt-1 w-56 origin-top-right divide-y divide-gray-100 rounded bg-transparent shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
