...
export default function Layout({ children }: Props) {
  return (
    <main className="w-full min-h-screen">
      <header className="w-full bg-transparent h-20 shadow pr-4 flex justify-between ">
        <div className="flex items-center justify-center px-2  hover:bg-transparent hover:shadow-2xl h-full">
          <Link
            href="/home/users"
